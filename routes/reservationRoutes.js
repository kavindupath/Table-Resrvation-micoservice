...
router.post('/',[check('name').not().isEmpty(),check('email').not().isEmpty()], reservationControllers.createReservations);

router.patch('/:pid',[check('name').not().isEmpty()],reservationControllers.updateReservations);
